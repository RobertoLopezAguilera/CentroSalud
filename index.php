...
<div class="carousel-container">
    <div class="carousel" id="carousel">
        <div class="carousel-inner">
            ...
            <h2 style="text-align: center;">Atención todos los dias de la semana 24Hrs</h2>
...
<div class="grid-container"id="inicio">
    ...
    <div class="grid-item">
        <div class="grid-content">
            ...
            <p>Estás dando el primer paso hacia una vida saludable: la información.</p>
            <p>Una vida saludable es un estilo de vida en el que disminuimos los riesgos de estar gravemente enfermo, así como de morir tempranamente.<br>La Organización Mundial de la Salud identifica varios pasos para una vida saludable. Estos están basados en la alimentación, la higiene y el deporte.</p>
            <p>*.-Dormir en los horarios adecuados. El buen descanso nocturno y aprovechar la luz solar revitaliza nuestro organismo.</p>
            <p>*.-Evitar el sedentarismo (¡estar todo el día mirando series no es lo más saludable!)</p>
            <p>*.-Asiste al médico regularmente. Una vez al año, cada dos años, cada 6 meses, tu médico te lo dirá cuando es necesario verte la próxima vez.</p>
            <p>*.-Alimentarse con una nutrición variada, con mayor cantidad de frutas y vegetales, que de carne animal, y aún menos de alimentos prefabricados o industriales.</p>
            <p>*.-Mantener el peso corporal dentro de los límites saludables (Índice de Masa Corporal entre 18.5 y 25).</p>
            <p>*.-Realizar actividad física diariamente, de manera enérgica, si es posible todos los días.</p>
            <p>*.-Reemplazar grasas saturadas por grasas no saturadas.</p>
            <p>*.-Consumir alimentos bajos en grasas, bajos en azúcares, bajos en sal.</p>
        </div>
    </div>
    <div class="grid-item"id="tec">
        <div class="grid-content">
            ...
            <p>estos son unas smartband que te pueden ayudar a mantener tu salud</p>
            <p>Fitbit: Conocido por sus wearables como el Fitbit Charge o Versa, que monitorean pasos, ritmo cardíaco, sueño y más. Sincronizables con la aplicación móvil Fitbit.</p> 

            <p>Apple Watch: Ofrece funciones avanzadas de salud como electrocardiograma (ECG), detección de caídas, seguimiento de actividad física y de sueño. Sincronizable con la app Health en dispositivos iOS.</p> 

            <p>Samsung Galaxy Watch: Disponible en varias ediciones, incluyendo funciones de seguimiento de ejercicio, monitorización de ritmo cardíaco y sueño, conectividad con la app Samsung Health.</p> 

            <p>Garmin: Ofrece smartwatches y dispositivos específicos para deportes como el Garmin Forerunner y Vivoactive, que monitorizan el rendimiento deportivo, el sueño y más, sincronizables con Garmin Connect.</p> 

            <p>Xiaomi Mi Band: Una smart band económica que monitoriza pasos, frecuencia cardíaca, sueño y ofrece recordatorios sedentarios, conectable con la app Mi Fit.</p> 

            <p>Withings: Ofrece dispositivos como el Steel HR y Pulse HR, que monitorizan la actividad física, ritmo cardíaco y sueño, conectables con la app Health Mate.</p> 
    ...
    <div class="grid-item">
        <div class="grid-content">
            ...
            <p>El Centro de Salud se complace en ofrecer servicios de salud preventiva directamente en las escuelas de nuestra comunidad. Creemos que la educación en salud es fundamental para el bienestar de los estudiantes y para promover hábitos saludables desde una edad temprana. Nuestro programa de visitas escolares está diseñado para proporcionar evaluaciones de salud preventivas y educación sobre temas clave de salud adaptados a las necesidades específicas de cada grupo de edad.Para organizar una visita del Centro de Salud a su escuela, se requiere lo siguiente:</p>
            <p>Coordinación Previa: Comuníquese con nuestro equipo administrativo para programar la visita y discutir los temas específicos que le gustaría abordar en la sesión educativa.Espacio Adecuado: Necesitaremos un espacio adecuado dentro de la escuela para llevar a cabo las evaluaciones de salud y la sesión educativa, preferiblemente una sala que pueda acomodar cómodamente a los estudiantes y al personal médico.Autorización Parental: Es fundamental obtener el consentimiento informado de los padres o tutores de los estudiantes participantes antes de la visita. Proporcionaremos formularios de consentimiento para que los padres los firmen antes de la fecha programada.Colaboración con el Personal Escolar: Trabajaremos estrechamente con el personal educativo y administrativo de la escuela para asegurarnos de cumplir con todas las normativas y horarios establecidos.</p>  
